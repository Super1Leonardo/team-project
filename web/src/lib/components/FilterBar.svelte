<script lang="ts">
	...
	// Разрешаем передачу любых атрибутов (включая data-testid) на корневой элемент
...
<div class="flex w-fit flex-wrap items-center gap-4 rounded-lg border bg-card p-4" {...restProps}>
