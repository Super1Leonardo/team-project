...
export const mockClusters: Cluster[] = [
	{
		...
		duplicates: [
			...
			{ title: 'Ошибка 500 при попытке оплаты', source: 'Twitter / X', publishedAt: '2026-03-14T09:55:00Z', mlScore: 0.91 }
		]
	},
	{
		id: 'cl-10493',
		...
		duplicates: [{ title: 'Обзор нового кешбэка от Brand Bank', source: 'Habr', publishedAt: '2026-03-14T10:45:00Z', mlScore: 0.88 }]
	},
	{
		id: 'cl-10494',
		...
		mlScore: 0.85,
		riskWords: ['техработы'],
		text: 'Завтра с 02:00 до 04:00 по московскому времени возможны краткосрочные прерывания...',
		duplicates: []
	},
	{
		id: 'cl-10495',
		...
		duplicates: [{ title: 'Акции ВкусМаркета растут на слухах о сделке', source: 'Telegram: Market Watch', publishedAt: '2026-03-14T11:40:00Z', mlScore: 0.75 }]
	}
];

// 2. Агрегированные данные для страницы Аналитики (Таймлайн)
export const mockAnalyticsTimeline = [
	{ date: '2026-03-08', positive: 120, negative: 15, neutral: 45, mlConfidence: 0.92 },
	{ date: '2026-03-09', positive: 132, negative: 18, neutral: 50, mlConfidence: 0.89 },
	// Spike-алерт: дата, когда произошел инцидент (много негатива)
	{ date: '2026-03-10', positive: 101, negative: 189, neutral: 40, mlConfidence: 0.95 }, 
	{ date: '2026-03-11', positive: 145, negative: 40, neutral: 55, mlConfidence: 0.91 },
	{ date: '2026-03-12', positive: 160, negative: 22, neutral: 60, mlConfidence: 0.94 },
	{ date: '2026-03-13', positive: 150, negative: 18, neutral: 58, mlConfidence: 0.93 },
	{ date: '2026-03-14', positive: 170, negative: 12, neutral: 45, mlConfidence: 0.96 }
];